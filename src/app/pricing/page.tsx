...
const plans = [
  {
    ...
    features: [
      ...
      "Main photo & star rating",
      "Opening hours",
      "Tap-to-call phone number",
      "Tap-to-navigate location",
      "Website & menu link",
      "Social media links",
      "Launch notification when you join",
      "7-day algorithm boost for visibility",
    ],
  },
  {
    name: "Spotlight",
    ...
    features: [
      ...
      "Listing analytics",
      'Indirect marketing (e.g. "Zahlé Votes")',
  ...
  },
  {
    ...
    features: [
      ...
      "12 push notifications per month (≈3/week)",
      "Homepage banner placement",
      "Direct marketing on TikTok & Instagram",
      "Advanced listing analytics",
      "Category exclusivity — no competitor in your category can buy this plan",
    ],
  },
];
